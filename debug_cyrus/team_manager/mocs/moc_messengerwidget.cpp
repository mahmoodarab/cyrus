...
#include "../../../Team_manager/TeamManager/messengerwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MessengerWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 63, 11)
    ...
    "MessengerWidget\0printText\0\0newMessage\0"
    "const char*\0msg\0category\0comboChange"
};
...
void MessengerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MessengerWidget *_t = static_cast<MessengerWidget *>(_o);
        switch (_id) {
        case 0: _t->printText(); break;
        case 1: _t->newMessage((*reinterpret_cast< const char*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 2: _t->comboChange((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject MessengerWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MessengerWidget.data,
      qt_meta_data_MessengerWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MessengerWidget.stringdata))
        return static_cast<void*>(const_cast< MessengerWidget*>(this));
