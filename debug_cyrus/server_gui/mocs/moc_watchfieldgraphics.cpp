...
#include "../../../cyrus2014/TeamManager/watchfieldgraphics.h"
...
QT_MOC_LITERAL(5, 59, 2),
QT_MOC_LITERAL(6, 62, 15),
QT_MOC_LITERAL(7, 78, 9)
    },
    "WatchFieldGraphics\0drawBounds\0\0"
    "updateRobotState\0RobotState\0st\0"
    "updateBallState\0BallState"
};
...
void WatchFieldGraphics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->drawBounds(); break;
        case 1: _t->updateRobotState((*reinterpret_cast< const RobotState(*)>(_a[1]))); break;
        case 2: _t->updateBallState((*reinterpret_cast< const BallState(*)>(_a[1]))); break;
        default: ;
        }
    }
}
