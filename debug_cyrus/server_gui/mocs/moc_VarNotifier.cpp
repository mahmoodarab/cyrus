...
#include "../../../cyrus2014/shared/tools/vartypes/vartypes/VarNotifier.h"
...
void VarTypes::VarNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VarNotifier::*_t)(VarPtr );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VarNotifier::changeOccurred)) {
                *result = 0;
            }
        }
    }
